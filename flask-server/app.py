...
def ObtenerIngredientes():
        ...
        if not api_key:
            ...
            try:
                ...
                model="gpt-3.5-turbo", messages=[{"role": "user", "content": f"haz una receta (debe ser un postre) con los siguientes ingredientes {nombres_ingredientes} (la estructura es titulo, ingredientes, instrucciones)"}])
